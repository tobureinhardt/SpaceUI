    ...
    Assets.Dashboard.NewTab = function(data)
        ...
        tab.Functions.NewModule = function(data)
            ...
            ModuleData.Functions.Settings.TextBox = function(data)
                ...
                inputDepth.AnchorPoint = Vector2.new(0, 0.5)
                inputDepth.BackgroundTransparency = 1
                inputDepth.Position = UDim2.new(0, -10, 0.5, 0)
                inputDepth.Size = UDim2.new(1, 20, 1, 0)
                ...
                focusedBg.Offset = Vector2.new(-1, 0)
                ...
                BoxInput.AnchorPoint = Vector2.new(0, 0)
                BoxInput.BackgroundTransparency = 1
                BoxInput.Position = UDim2.new(0, 0, 0, 0)
                BoxInput.Size = UDim2.new(1, 0, 1, 0)
                BoxInput.ZIndex = 4
            ...
            ModuleData.Functions.Settings.MiniToggle = function(data)
                ...
                -- Exe5 Option / Toggle button style
            ...
            ModuleData.Functions.Settings.Slider = function(data)
                ...
                SliderFrame.Position = UDim2.new(0.5, 0, 0, 120)
                ...
                sliderBgDepth.AnchorPoint = Vector2.new(0, 0.5)
                sliderBgDepth.BackgroundTransparency = 1
                sliderBgDepth.Position = UDim2.new(0, -10, 0.5, 0)
                sliderBgDepth.Size = UDim2.new(1, 20, 1, 0)
                ...
                minLabel.AnchorPoint = Vector2.new(0, 0.5)
                minLabel.BackgroundTransparency = 1
                minLabel.Position = UDim2.new(0, 10, 0.5, 0)
                ...
                maxLabel.AnchorPoint = Vector2.new(1, 0.5)
                maxLabel.BackgroundTransparency = 1
                maxLabel.Position = UDim2.new(1, -10, 0.5, 0)
                maxLabel.Size = UDim2.new(0, 40, 1, 0)
                maxLabel.ZIndex = 4
                ...
                SliderBtn.Size = UDim2.new(0, 26, 0, 26)
                SliderBtn.Text = ""
                SliderBtn.ZIndex = 5
                ...
                handleImg.Size = UDim2.new(0, 26, 0, 26)
            ...
            ModuleData.Functions.Settings.Dropdown = function(data)
                ...
                -- Exe5 Choose Player / Dropdown button style
